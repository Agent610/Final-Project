      ...
      <div className="about__content">
        ...
        <div className="about__text-content">
          ...
          <p className="about__text">
            ...
            frontend. I Parth, from wanting to become a Connecticut
            State-Trooper to now a Software Engineer I'm ready to do any
            project, assignment and provide meaningful solutions for my company
            that I work with .
          </p>
        </div>
      </div>
